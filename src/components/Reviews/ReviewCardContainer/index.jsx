    ...
    return (
        <div className="review_card_container">
            <ReviewCard 
                ...
                [Company Name]'s courses were perfect for me. The instructors were knowledgeable and supportive, 
                and the hands-on projects gave me the practical experience I needed to apply what I learned. 
                I highly recommend [Company Name] to anyone looking to improve their IT skills."
            />
            <ReviewCard 
                name="Paul Gramsch"
                image={Person2}
                desctiption="I was hesitant to take an online course, but [Company Name] exceeded my expectations. 
            ...
            <ReviewCard 
                name="Samantha Smith"
                image={Person3}
                desctiption="I recently completed [Company Name]'s data science course and I have to say it was one of the best 
                ...
                problems. I would highly recommend [Company Name]'s data science course to anyone looking to break into this exciting field."
            />
        </div>
    )
}
