...
const ApplicationForm = ({ name, callback }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!phoneNumber.match(phoneRegex)) {
            errors.phoneNumber = 'Invalid phone number. It should be in the format 07*******.';
        }
    ...
    return (
        <form className="application_form">
            ...
            <FloatingLabel controlId="floatingInput" label="Phone Number" className="mb-4" >
                <Form.Control
                    type="text"
                ...
                />
                {!validationErrors.phoneNumber && <p>Please enter a phone number in the format 07*******.</p>}
                {validationErrors.phoneNumber && <p className="error_message">{validationErrors.phoneNumber}</p>}
            </FloatingLabel>
